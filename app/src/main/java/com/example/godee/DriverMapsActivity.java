...
//        requestPermission();
        ...
        SearchView searchView = findViewById(R.id.driverLocationSearch);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (addressList.size() == 0) {
                    Toast.makeText(DriverMapsActivity.this, "Location not found", Toast.LENGTH_SHORT).show();
                }
                else {
...
//                    drawRoute(userCurrentLocationInstance, latLng);
                    ...
                    Toast.makeText(DriverMapsActivity.this, userCurrentLocationInstance.latitude + " " + userCurrentLocationInstance.longitude, Toast.LENGTH_SHORT).show();
                    Toast.makeText(DriverMapsActivity.this, query, Toast.LENGTH_SHORT).show();
                }
                return false;
            }
